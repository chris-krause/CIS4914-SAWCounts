...
%disp('kid')
%[a,b,c] = hGetNext(horizontalMat, verticalMat, 1, 1, 1)
%disp('cudi')
%[d,e,f] = hGetNext(horizontalMat, verticalMat, 1, 1, 3)
%[a,b,c] = vGetNext(horizontalMat, verticalMat, 1, 1, 2)
%[d,e,f] = hGetNext(horizontalMat, verticalMat, 1, 2, 3)
%[a,b,c] = vGetNext(horizontalMat, verticalMat, 2, 2, 2)
